...
const IconDocument = ({size, onClick}) => {
  return (
    <svg width={size} height={size} onClick={onClick} viewBox="0 0 16 16" className="bi bi-file-earmark-richtext" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
